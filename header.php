...
<html>
<head>
	<title>TOKO ONLINE MEKONGGA</title>
		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +6282397994831</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> mekongga20@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>mekongga 20 sultra</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #ff8680"><b>TOKO ONLINE MEKONGGA 20</b></a>
			</div>
